...
var initGame = function () {
    ...
    return new Game(canvas.getContext("2d"), window.innerWidth / 2 - (15 * 15 / 2), 20, grid, bag, fallingType, 0, spawnPiece(grid, fallingType), null, 20, 0, 5, 0, 20, 0, true, generateGrcXyLut(ROWS, COLS));
};
var main = function () {
